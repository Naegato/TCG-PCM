...
\deepclone_from_array([
    ...
    'properties' => [
        'App\\Game\\State\\GameState' => [
            'currentPlayer' => ['1', 14 => '2'],
            'lastAddedCardId' => [null, 14 => null],
            'cards' => [
                ['player1_character' => 1, 'player2_character' => 2],
                14 => ['player1_character' => 15, 'player2_character' => 16, 'player1_draw1' => 17, 822569776 => 18, 'player2_draw1' => 20, 'player1_draw2' => 21, 2137449172 => 22, 'player2_draw2' => 23],
            ],
            'randomizer' => [3, 14 => 24],
            'player1' => [4, 14 => 25],
            'player2' => [7, 14 => 27],
            'lastEventId' => [null, 14 => 74],
            'seed' => [1234, 14 => 1234],
        ],
        'App\\Game\\Card\\CardState' => [
            'instanceId' => [1 => 'player1_character', 'player2_character', 15 => 'player1_character', 'player2_character', 'player1_draw1', '822569776', 20 => 'player2_draw1', 'player1_draw2', '2137449172', 'player2_draw2'],
            'templateId' => [1 => 'DataCenter', 'Pierrot', 15 => 'DataCenter', 'Pierrot', 'D6', 'DataMiner', 20 => 'D6', 'D6', 'DataMiner', 'D6'],
            'ownerId' => [1 => '1', '2', 15 => '1', '2', '1', '1', 20 => '2', '1', '1', '2'],
            'effects' => [
                1 => [],
                [],
                15 => [],
            ...
            'values' => [
                1 => [],
                [],
                15 => ['turnRemainingBeforeAction' => 1],
        ...
        'App\\Game\\State\\PlayerState' => [
            'player' => [4 => 5, 7 => 8, 25 => 5, 27 => 8],
            'healthPoints' => [4 => 300, 7 => 300, 25 => 300, 27 => 300],
            'maxHealthPoints' => [4 => 300, 7 => 300, 25 => 300, 27 => 300],
            'characterCardId' => [4 => 'player1_character', 7 => 'player2_character', 25 => 'player1_character', 27 => 'player2_character'],
            'hand' => [
                4 => [],
                7 => [],
                25 => ['player1_draw1', 'player1_draw2'],
                27 => ['player2_draw1', 'player2_draw2'],
            ],
            'drawPile' => [
                4 => ['player1_draw1' => 'D6', 'player1_draw2' => 'D6', 'player1_draw3' => 'D6'],
                7 => ['player2_draw1' => 'D6', 'player2_draw2' => 'D6', 'player2_draw3' => 'D6'],
                25 => ['player1_draw3' => 'D6'],
                27 => ['player2_draw3' => 'D6'],
            ],
            'coins' => [4 => 5, 7 => 5, 25 => 12, 27 => 11],
            'playArea' => [4 => 6, 7 => 9, 25 => 26, 27 => 9],
            'discardPile' => [
                4 => [],
                7 => [],
                25 => [],
        ...
        'App\\Game\\State\\PlayArea' => [
            ...
            'monsterCards' => [
                6 => [],
                9 => [],
                26 => ['822569776', '2137449172'],
            ],
        ],
        'App\\Game\\State\\GameEvent' => [
            'id' => [10 => 71, 72, 73, 74],
            'type' => [10 => \App\Enum\GameEventTypeEnum::TURN_STARTED, \App\Enum\GameEventTypeEnum::TURN_ENDED, \App\Enum\GameEventTypeEnum::TURN_ENDED, \App\Enum\GameEventTypeEnum::TURN_ENDED],
            'eventOrigin' => [10 => 'player_event', 'player_event', 'player_event', 'player_event'],
            'data' => [
                10 => ['playerId' => '1'],
                ['playerId' => '1'],
                ['playerId' => '2'],
            ...
            'parentId' => [10 => null, null, null, null],
            'localId' => [10 => 0, 0, 0, 0],
        ],
        'App\\Game\\Card\\MonsterCardState' => [
            'currentHealthPoints' => [18 => 10, 22 => 10],
            'canAttack' => [18 => true, 22 => true],
        ],
    ...
    'resolve' => [
        'App\\Game\\State\\GameState' => [
            'cards' => [
                ...
                14 => ['player1_character' => true, 'player2_character' => true, 'player1_draw1' => true, 822569776 => true, 'player2_draw1' => true, 'player1_draw2' => true, 2137449172 => true, 'player2_draw2' => true],
            ],
            'randomizer' => [true, 14 => true],
            'player1' => [true, 14 => true],
            'player2' => [true, 14 => true],
        ],
        'App\\Game\\State\\PlayerState' => [
            'player' => [4 => true, 7 => true, 25 => true, 27 => true],
            'playArea' => [4 => true, 7 => true, 25 => true, 27 => true],
        ],
        'App\\Game\\Card\\CardState' => [
            'effects' => [
                18 => [true],
